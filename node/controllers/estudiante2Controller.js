...
resultadoModel.belongsTo(postulacionModel, { foreignKey: 'id_resultados' });
postulacionModel.hasOne(resultadoModel, { foreignKey: 'id_resultados' });
...
export const obtenerResultados = async (req, res) => {
  try {
    const rut = req.body.rut_estudiante;
